...
#储存
#nx.write_weighted_edgelist(l, "D:\pythonProject\selfmake_subnet\subnetwork{}-{}".format(t,d))
nx.write_weighted_edgelist(l, "D:\pythonProject\sub\{}-{}".format(t, d))
